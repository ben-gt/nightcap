...
flyctl deploy \
  ...
  --build-arg "EXPO_PUBLIC_AIRWALLEX_ENV=${EXPO_PUBLIC_AIRWALLEX_ENV:-}" \
  --build-arg "EXPO_PUBLIC_AIRWALLEX_PUBLISHABLE_KEY=${EXPO_PUBLIC_AIRWALLEX_PUBLISHABLE_KEY:-}" \
  --build-arg "EXPO_PUBLIC_PAYMENT_INTENT_ENDPOINT=${EXPO_PUBLIC_PAYMENT_INTENT_ENDPOINT:-}" \
  "$@"
