...
ARG EXPO_PUBLIC_AIRWALLEX_ENV
ARG EXPO_PUBLIC_AIRWALLEX_PUBLISHABLE_KEY
ARG EXPO_PUBLIC_PAYMENT_INTENT_ENDPOINT
...
ENV EXPO_PUBLIC_AUTH0_DOMAIN=$EXPO_PUBLIC_AUTH0_DOMAIN \
    ...
    EXPO_PUBLIC_AIRWALLEX_ENV=$EXPO_PUBLIC_AIRWALLEX_ENV \
    EXPO_PUBLIC_AIRWALLEX_PUBLISHABLE_KEY=$EXPO_PUBLIC_AIRWALLEX_PUBLISHABLE_KEY \
    EXPO_PUBLIC_PAYMENT_INTENT_ENDPOINT=$EXPO_PUBLIC_PAYMENT_INTENT_ENDPOINT \
    CI=1
